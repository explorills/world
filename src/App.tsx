        ...
        <DialogContent className="bg-black/95 border-primary/50 backdrop-blur-xl max-w-[var(--modal-max-width-lg)]">
          <DialogHeader>
            <DialogTitle className="text-[length:var(--text-2xl)] font-bold text-primary flex items-center gap-2 sm:gap-3">
              <FolderOpen className="w-5 h-5 sm:w-7 sm:h-7 shrink-0" weight="duotone" />
              Resources
            </DialogTitle>
          ...
          <div className="space-y-4 sm:space-y-6 pt-2 sm:pt-4">
            <div>
              <h3 className="font-bold text-[length:var(--text-lg)] text-primary mb-2 sm:mb-3">ONE Ecosystem</h3>
              <div className="space-y-2">
                <a 
                  href="https://expl.one/" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="block p-3 sm:p-4 bg-muted/30 rounded-lg border border-primary/20 hover:border-primary/40 transition-colors"
                >
                  <div className="font-semibold text-primary flex items-center justify-between text-[length:var(--text-sm)] sm:text-[length:var(--text-base)]">
                    EXPL.ONE
                    <span className="text-[length:var(--text-xs)] text-accent">Visit →</span>
                  </div>
                </a>
                ...
                >
                  <div className="font-semibold text-primary flex items-center justify-between text-[length:var(--text-sm)] sm:text-[length:var(--text-base)]">
                    ONE documentation
                    <span className="text-[length:var(--text-xs)] text-accent">View Docs →</span>
                  </div>
                </a>
              </div>
            </div>
            ...
            <div>
              <h3 className="font-bold text-[length:var(--text-lg)] text-accent mb-2 sm:mb-3">Socials</h3>
              <div className="flex flex-wrap gap-2 sm:gap-4">
                <a 
                  href="https://discord.gg/DMSSuPPrTV/" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="flex-1 min-w-[80px] p-2 sm:p-4 bg-muted/30 rounded-lg border border-accent/20 hover:border-accent/40 transition-all hover:scale-105 flex items-center justify-center gap-1 sm:gap-2"
                >
                  ...
                  <span className="text-[length:var(--text-sm)] font-medium hidden xs:inline">Discord</span>
                </a>
                <a 
                ...
                >
                  ...
                  <span className="text-[length:var(--text-sm)] font-medium hidden xs:inline">X</span>
                </a>
                <a 
                ...
                >
                  ...
                  <span className="text-[length:var(--text-sm)] font-medium hidden xs:inline">GitHub</span>
                </a>
              </div>
            </div>
          </div>
